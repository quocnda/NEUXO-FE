...
interface IModalAddNoteGuestProps {
...
const ModalAddNoteGuest: FCC<IModalAddNoteGuestProps> = ({
  children,
  addNote,
  guest_id,
  guest_name,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleToggle}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            <Tag className="bg-secondary-blue text-xl">{guest_name} Notes</Tag>
          </DialogTitle>
        </DialogHeader>
        <VStack spacing={12}>
...
export default ModalAddNoteGuest;
