...
const BoxChatContact = (props: Props) => {
  const {
    setLoadingText,
    loadingText,
    messages,
  ...
  const sendMessage = async (newMessages: any[]) => {
    try {
      ...
      const response = await axios.post(
        `${env.API_URL}/data/contact/send-message-contact`,
        {
      ...
      <div className="mx-auto py-2">
        ...
        <form onSubmit={handleSubmit} className="relative">
          ...
          <Button
            ...
            disabled={loading || loadingText || isFetching || !valueContact}
          >
            <ArrowUpIcon size={16} />
          </Button>
        </form>
