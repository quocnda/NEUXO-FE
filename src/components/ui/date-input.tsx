...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="border-input bg-main-dark-gray text-main-0 flex items-center border-none px-1 text-sm">
      <input
        type="text"
        ref={dayRef}
        max={31}
        ...
        className="bg-main-dark-gray w-7 border-none p-0 text-center outline-none"
        placeholder="D"
      />
      ...
      <input
        ...
        className="bg-main-dark-gray w-6 border-none p-0 text-center outline-none"
        placeholder="M"
      />
      <span className="-mx-px ">/</span>
      <input
        ...
        className="bg-main-dark-gray w-12 border-none p-0 text-center outline-none"
        placeholder="YYYY"
      />
    </div>
  );
