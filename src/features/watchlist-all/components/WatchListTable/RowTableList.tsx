      ...
      switch (column?.title) {
        ...
        case 'note':
          return (
            ...
            >
              <div>
                <TextBody1 className={cn('cursor-pointer')}>{shortenName(item?.note, 20) || '-'}</TextBody1>
              </div>
            </Tooltip>
          );
        case 'ICP':
          return (
            ...
            >
              <div>
                <TextBody1 className={cn('cursor-pointer')}>{shortenName(item?.icp_name, 20) || '-'}</TextBody1>
              </div>
            </Tooltip>
          );
        case 'insert_time':
        ...
        default:
          return (
            <Tooltip
              ...
              label={<div className="max-w-[200px] whitespace-pre-wrap">{(item as any)[column?.title]}</div>}
            >
              <div>
                <TextBody1>
