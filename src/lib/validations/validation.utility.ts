...
export const twitterUrlRegex = /^https?:\/\/(?:www\.)?(?:x\.com|twitter\.com)\/([a-zA-Z0-9_]{1,15})+\/?$/;
export const facebookUrlRegex = /^https?:\/\/(?:www\.)?facebook\.com\/([a-zA-Z0-9_]{1,})$/;

export const linkedinUrlRegex = /^(https?:\/\/)?(www\.)?linkedin\.com\/(in|company)\/[\p{L}\p{N}_\-@.&#]+\/?$/u;
...
export const validationMessages = {
  ...
  trim: (field?: string) => (field ? `${field} must not have whitespaces.` : 'This field must not have whitespaces.'),
};
