...
import { ExpandedRowProvider } from '@/components/contexts/ExpandedRowContext';
import { FiltersProvider } from '@/components/contexts/FilterContextProps';
import { QueryParamsProvider } from '@/components/contexts/QueryParamsContext';
...
const MyApp = (props: AppPropsWithLayout) => {
  ...
  return (
    <>
      ...
      <div>
        <GoogleOAuthProvider clientId={env.WEB_GOOGLE_SOCIAL_APP_ID}>
          <Provider>
            <QueryParamsProvider>
              <FiltersProvider>
                <ExpandedRowProvider>
